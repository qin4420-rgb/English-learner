      ...
      <main className="main-area">
        ...
        <div className="content-wrap">
          {loading ? <div className="loading-screen"><span className="loader" />正在打开你的学习空间…</div> : <>
            ...
            {view === "library" && <ResourceLibrary resources={resources} jobs={jobs} mediaProgress={progress} onRead={(resource) => startLearning(resource, "Reading")} onStartLearning={startLearning} onOpenMaintenance={openMaintenance} onReloadResources={loadResources} onNotice={setNotice} onToggleFavorite={toggleFavorite} />}

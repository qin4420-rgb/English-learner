...
export const RESOURCE_TYPES = ["Article", "PDF", "Image", "Audio", "Video", "Subtitle", "Text", "WordList", "Dictionary", "Other"] as const;
...
const TYPE_ALIASES: Record<string, ResourceType> = {
  ...
  audio: "Audio", "音频": "Audio", "播客": "Audio", podcast: "Audio",
...
export function resourceTypeLabel(type: ResourceType): string {
  return ({ Article: "文章", PDF: "PDF", Image: "图片", Audio: "音频", Video: "视频", Subtitle: "字幕", Text: "文本", WordList: "词库", Dictionary: "词典", Other: "其它" })[type];
}
...
function normalizeLearningUses(value: unknown, type: ResourceType): LearningUse[] {
  ...
  if (["Audio", "Video"].includes(type)) return ["Listening", "Speaking", "Vocabulary"];
